...
//        ImGuiFreeType.buildFontAtlas(fontAtlas, ImGuiFreeType.RasterizerFlags.LightHinting);
    ...
    private void menuBar(float dt)
    {
    	//ImGui.begin("window");
    	String fps = Scene.getCurrentFps(dt, true, 5);
        ...
        if(ImGui.beginMenu("File"))
        {
            ...
            ImGui.menuItem("fruits");
            ImGui.menuItem("hellWorld");
        ...
        ImGui.begin("Testing Features");
        ImGui.inputText("Enter an int",i);
        ImGui.inputText("output", i);
        ...
        ImGui.textColored(f[0], f[1], f[2], 1, "testingColor");
        ImGui.colorEdit3("color", f);
        ImGui.colorPicker4("picker", f);
